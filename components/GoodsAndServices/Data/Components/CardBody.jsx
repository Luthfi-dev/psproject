                    ...
                    <td>
                      <Tooltip
                        ...
                        <Link href={{
                          ...
                          <div className="symbol symbol-45px me-2 cursor-pointer" data-bs-toggle="tooltip" title={row.kegiatan.project.project_name}>
                      ...
                      <div className="d-flex align-items-center flex-grow-1">
                        <div className="symbol symbol-45px me-5 ">
                          <div className="container-img w-45px">
                            {
                              row.supervisor?.avatar  ?
                              <Image 
                              src={row.supervisor?.avatar+'?subfolder=avatars&'}
                              loader={serverAssets}
                              alt="" layout="fill" className="img symbol  "/>
                              :
                              <span className={'symbol-label fs-2 fw-bold text-uppercase bg-'+bgList[Math.floor(Math.random()*bgList.length)]+' text-light'}>{stringHelper.initialProfile(row.supervisor.name,2)}</span>
