    ...
    <div className="card-header border-0 pt-5">
      <h3 className="card-title align-items-start flex-column">
        <span className="card-label fw-bolder fs-3 mb-1 text-primary">
          {data.pr_number} 
          <button type="button" data-action="copy" className="btn btn-active-color-primary btn-icon btn-sm btn-outline-light d-">
        ...
        <span className="text-muted mt-1 fw-bold fs-7">Purchese Requistion Number</span>
      </h3>
    </div>
  )
}
