const WaitingReport = ({appsData}) =>{
  return(
    <>
    <div class="col-xl-4">
      <a href="#" class="card bg-default hoverable card-xl-stretch mb-xl-8">
        <div class="card-body">
          ...
          <div class="text-primary fw-bolder fs-2 mb-2 mt-5">5 Activity</div>
          <div class="fw-bold text-primary">Waiting to Report</div>
        </div>
      </a>
    </div>
    <div class="col-xl-4">
