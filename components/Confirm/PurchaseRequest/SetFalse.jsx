...
const SetFalse = ({detail}) =>{
  const router = useRouter()
  const [result, setResult]=useState(false);
  const [alertMessage, setAlertMessage]=useState('Set result as FALSE successfully, thanks you !')
  const [alertTitle,setAlertTitle]=useState("SET AS FALSE")
    ...
    await put({
      ...
      if(res.data && res.data.code === 200 ){
        ...
        swal.fire({
          icon:'success',
          title:'Successfully !',
          text:"Set result as FALSE successfully, thanks you !",
          buttonsStyling: !1,
