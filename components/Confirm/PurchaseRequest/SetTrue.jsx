...
const SetTrue = ({detail}) =>{
  const router = useRouter()
  const [result, setResult]=useState(false);
  const [alertMessage, setAlertMessage]=useState('Set result as TRUE successfully, thanks you !')
    ...
    await put({
      ...
      if(res.data && res.data.code === 200 ){
        ...
        swal.fire({
          icon:'success',
          title:'Successfully !',
          text:"Set result as TRUE successfully, thanks you !",
          buttonsStyling: !1,
    ...
    <>
      <div className="pt-lg-10 mb-10">
        ...
        <div className="fw-bold fs-3 text-muted mb-15">
          {
            result === false && 
            'Set result as TRUE, Please wait ...'
          }
          {
            result === true && 
            <>
