		...
		<div className="d-flex flex-column flex-root bg-dark">
            ...
            404
					...
					<div className=" mb-0 pt-10">
						<div className="fw-normal opacity-50 fs-12 text-light mb-5">Sorry, the page not found<br/> The link you followed probably broken or the page has been removed.</div>
